...
<div
	class="card flex lg:flex-row flex-col w-[80%] variant-ghost-primary m-1 rounded-lg cursor-default py-2 dark:text-surface-50"
>
	...
	<div
		class="lg:border-r-[1px] lg:border-b-0 {desc
			? 'border-b-[1px]'
			: 'hidden'} mx-3 lg:mx-0 border-surface-500 mt-0.5 lg:mt-0"
	/>
	{#if desc}
